...
/**
 * This class stores methods related selenium webdriver
 * @author Akash
 *
 */
...
public class WebDriverUtility {
	...
	public void implicitWait(WebDriver driver) {
		driver.manage().timeouts().implicitlyWait(IPathConstant.IMPLICITWAIT, TimeUnit.SECONDS);
	}
	...
	/**
	 * This method waits for the title
	 * @param driver
	 * @param title
	 */
	public void waitForTitle(WebDriver driver, String title) {
		WebDriverWait wait=new WebDriverWait(driver, IPathConstant.EXPLICITWAIT);
